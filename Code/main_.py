...
if __name__ == '__main__':
    ...
    n_symbol = 2
    snr_start, snr_end = 12, 12

    # deep learning models list 'ADNN', 'Sionna', 'SionnaPlus', 'Transformer', 'LSTM', 'ViterbiNet'
    models_list = ['SionnaPlus', 'Transformer', 'LSTM']#['ADNN', 'Sionna', 'SionnaPlus', 'Transformer', 'LSTM', 'ViterbiNet', 'ClassicViterbi']
    detector_method = 'EndToEnd'  # ModelBased / EndToEnd / Statistical
